...
namespace Books.Infrastructure.Migrations
{
    ...
    [Migration("20250218225928_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Books.Core.Entities.BookStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Books.Core.Entities.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Books.Core.Entities.Book", b =>
                {
                    b.HasOne("Books.Core.Entities.BookStatus", "BookStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("Books.Core.Entities.Order", b =>
                {
                    b.HasOne("Books.Core.Entities.OrderStatus", "Status")
                        .WithMany("Orders")
