...
public class UserActiveSessionsService : IUserActiveSessionsService
{
    ...
    public async Task<UserActiveSessions> AddUserDeviceTokenAsync(CreateUserDeviceTokenDto token)
    {
    ...
    public async Task<UserActiveSessions> GetUserDeviceTokenAsync(Guid userId)
    {
    ...
    public async Task<UserActiveSessions> UpdateUserDeviceTokenAsync(UpdateUserDeviceTokenDto tokenDto)
    {
    ...
    public async Task<UserActiveSessions> DeleteUserDeviceTokenAsync(Guid tokenId)
    {
